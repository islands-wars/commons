...
/**
 * File <b>Filter</b> located on fr.islandswars.commons.service.collection
 * Filter is a part of commons.
 * <p>
...
public class Filter {
	...
	private Filter(String name, Type type, Object value) {
		if (!type.hasName() && name != null)
			throw new IllegalArgumentException();
		if (!type.getValue().isInstance(value))
			throw new IllegalArgumentException();
		this.name = name;
		this.type = type;
		this.value = value;
	...
	/**
	 * Get the handler of this filter
	 *
	 * @return the handler
	 */
	public Type getType() {
