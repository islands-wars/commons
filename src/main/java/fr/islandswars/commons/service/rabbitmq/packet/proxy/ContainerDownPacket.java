...
/**
 * File <b>ContainerDownPacket</b> located on fr.islandswars.commons.service.rabbitmq.packet.proxy
 * ContainerDownPacket is a part of commons.
 * <p>
 ...
 * Created the 07/07/2024 at 21:22
 * @since 0.3.1
 */
public class ContainerDownPacket  extends Packet {

    private UUID containerId;

    public ContainerDownPacket() {
        super(PacketType.Status.CONTAINER_DOWN_REQUEST.getId());
    }
